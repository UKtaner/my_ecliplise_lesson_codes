...
public class List01 {
	...
	public static void main(String[] args) {
		...
		for(int i=0; i<c.length; i++) {
			...
			lc.add(c[i]);// adding from array to list 
		}
	...
	//	We will use Arrays.asList() method to convert an array to a list.
		...
		Integer irr[] = {2, 5, 3, 1};
// 		to use asList method in List from array to List, array data type must be non primitive. 
...
//		l3c.add(7);
//		System.out.println(l3c);
// wanted add 7 to l3c and l3c was converted to List, but array length is fixed, not resizeable.
		// but in List possible to resize the length but l3c is converted from array first, still having array features, will act still as array not List.
//		l3c.remove(1);
//		System.out.println(l3c);
...
// 		After converting from list to array, you can not add element to array unless update to size of list.Bcoz array gets the length from list in this example.		
	}
