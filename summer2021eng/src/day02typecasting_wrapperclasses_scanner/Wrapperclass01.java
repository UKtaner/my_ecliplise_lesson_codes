...
public class Wrapperclass01 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		Integer b = 12;							 //          Non-primitive data
		...
		Short c = 123;							   //          Non-primitive data
		...
		System.out.println(c.hashCode());//24533 ==> It returns the address of the Non-Primitive
		
		
		Short d = 123;                                //          Non-primitive data
		System.out.println(c.equals(d));//true
		
		// Boxing is to assign the same value from one to other (from primitive to Wrapper Class(Non-Primitive) or)
