 ...
 */
		...
		System.out.println("Enter a,b or c in order to write a message");

		char responce=scan.next().toLowerCase().charAt(0);
		
		if (responce=='a' || responce=='b'|| responce=='c') {
		...
		case 'b':
			...
			break;
		case 'c':
			System.out.println("Sorry, no help is currently available is printed for any other value of response.");
			break;
		}
		}else {
