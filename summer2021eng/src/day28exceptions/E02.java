 ...
 */
	public static void main(String[] args) {
		...
		System.out.println(s2.length());// java will throw NullPointerException.Directly went to the "catch()" body
		System.out.println(12/0);// java skipped this message.
		}catch(NullPointerException e){
			System.out.println("Do not use length() for null"+ e.getStackTrace());
		}
