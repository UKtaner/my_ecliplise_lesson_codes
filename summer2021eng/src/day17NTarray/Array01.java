...
3)Arrays accept just "primitives" and "references" as data type, 
  you cannot store "non-primitive" data types in an array theoretically
4)Arrays are non-primitive
 */		

		//How to create an array
				int a[] = new int[5];// [5] shows size of the array of a.
				
				System.out.println(Arrays.toString(a));//[0, 0, 0, 0, 0]
				//How to add elements into an array
				// arrays use the index and starting from 0
				a[2] = 11;
				//[2]==> index number
